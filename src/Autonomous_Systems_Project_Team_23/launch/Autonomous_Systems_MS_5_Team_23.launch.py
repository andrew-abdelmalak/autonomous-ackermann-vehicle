"""MS5 simulation launch file for Team 23."""
...
def generate_launch_description():
    """Generate the launch description for MS5 simulation."""
    ...
    city_straight_speed = LaunchConfiguration('city_straight_speed')
    city_turn_speed = LaunchConfiguration('city_turn_speed')
    city_lookahead = LaunchConfiguration('city_lookahead')
    city_corner_radius = LaunchConfiguration('city_corner_radius')
    city_inside_bias_factor = LaunchConfiguration('city_inside_bias_factor')
    ...
    city_use_target_point_control = LaunchConfiguration('city_use_target_point_control')
    ...
    measurement_x_std = LaunchConfiguration('measurement_x_std')
    measurement_y_std = LaunchConfiguration('measurement_y_std')
    measurement_heading_std = LaunchConfiguration('measurement_heading_std')
    measurement_speed_std = LaunchConfiguration('measurement_speed_std')
    measurement_yaw_rate_std = LaunchConfiguration('measurement_yaw_rate_std')
    process_speed_std = LaunchConfiguration('process_speed_std')
    process_yaw_rate_std = LaunchConfiguration('process_yaw_rate_std')
    save_artifacts = LaunchConfiguration('save_artifacts')
    artifact_output_dir = LaunchConfiguration('artifact_output_dir')
    artifact_stem = LaunchConfiguration('artifact_stem')
    publish_noisy_state = LaunchConfiguration('publish_noisy_state')
    ...
    bridge = Node(
        ...
        remappings=[
            ...
            ('/model/vehicle/odometry', '/ms5/ideal_odom'),
        ],
        output='screen',
    )
    ...
    localization_node = Node(
        ...
        executable='ms5_localization_team_23',
        name='autonomous_systems_ms_5_localization_team_23',
        output='screen',
        parameters=[{
            'ideal_state_topic': '/ms5/ideal_odom',
            'filtered_state_topic': '/odom',
            'noisy_state_topic': '/ms5/noisy_odom',
            'measurement_x_std': measurement_x_std,
            'measurement_y_std': measurement_y_std,
            'measurement_heading_std': measurement_heading_std,
            'measurement_speed_std': measurement_speed_std,
            'measurement_yaw_rate_std': measurement_yaw_rate_std,
            'process_speed_std': process_speed_std,
            'process_yaw_rate_std': process_yaw_rate_std,
            'save_artifacts': save_artifacts,
            'artifact_output_dir': artifact_output_dir,
            'artifact_stem': artifact_stem,
            'publish_noisy_state': publish_noisy_state,
        }],
    )
    ...
    planning_node = Node(
        ...
        parameters=[{
            ...
            'city_straight_speed': city_straight_speed,
            'city_turn_speed': city_turn_speed,
            'city_lookahead': city_lookahead,
            'city_corner_radius': city_corner_radius,
            'city_inside_bias_factor': city_inside_bias_factor,
        }],
    )
    ...
    lateral_controller_node = Node(
        ...
        parameters=[{
            ...
            'desired_target_x_topic': '/ms4/desired_target_x',
            'desired_target_y_topic': '/ms4/desired_target_y',
            'steering_command_topic': steering_command_topic,
            'publish_rate_hz': publish_rate_hz,
            'desired_lane': 0.0,
            'desired_heading': 0.0,
            'use_target_point_control': city_use_target_point_control,
            'target_point_timeout_sec': 0.5,
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument(
            'empty_track_lane',
            default_value='0.0',
            description='Empty-track lane target for Track 1 / internal MS5 validation.',
        ),
        DeclareLaunchArgument(
            'empty_track_lane_transition_distance',
            default_value='0.0',
            description='Transition distance for the optional empty-track lane move.',
        ),
        DeclareLaunchArgument(
            'empty_track_lane_second',
            default_value='0.0',
            description='Optional second empty-track lane target.',
        ),
        DeclareLaunchArgument(
            'empty_track_lane_second_start',
            default_value='1000000000.0',
            description='X position at which to start the optional second lane transition.',
        ),
        DeclareLaunchArgument(
            'empty_track_lane_second_transition_distance',
            default_value='0.0',
            description='Distance over which to complete the optional second lane transition.',
        ),
        DeclareLaunchArgument(
            'racing_override_lane_profile',
            default_value='false',
            description='Override racing-track obstacle parsing with a fixed lane profile.',
        ),
        DeclareLaunchArgument(
            'racing_profile_lane_1',
            default_value='0.1875',
            description='Racing-track override lane 1 target.',
        ),
        DeclareLaunchArgument(
            'racing_profile_lane_2',
            default_value='-0.1875',
            description='Racing-track override lane 2 target.',
        ),
        DeclareLaunchArgument(
            'racing_profile_lane_3',
            default_value='0.1875',
            description='Racing-track override lane 3 target.',
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='2.0',
            description='Distance to complete switch 1.',
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            ...
            default_value='2.0',
            description='Distance to complete switch 2.',
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            'city_straight_speed',
            default_value='0.35',
            description='Target speed on City Track straights in m/s.',
        ),
        DeclareLaunchArgument(
            'city_turn_speed',
            default_value='0.18',
            description='Target speed on City Track turns in m/s.',
        ),
        DeclareLaunchArgument(
            'city_lookahead',
            default_value='0.15',
            description='City Track heading lookahead distance in meters.',
        ),
        DeclareLaunchArgument(
            'city_corner_radius',
            default_value='0.40',
            description='City Track planner corner radius in meters.',
        ),
        DeclareLaunchArgument(
            'city_inside_bias_factor',
            default_value='0.50',
            description='Blend between centerline (0) and inward-biased City path (1).',
        ),
        DeclareLaunchArgument(
            'city_use_target_point_control',
            default_value='false',
            description='Use City Track point-tracking control instead of shared lane-heading mode.',
        ),
        DeclareLaunchArgument(
            'initial_x',
            default_value='0.0',
        ...
        DeclareLaunchArgument(
            'publish_rate_hz',
            default_value='20.0',
            description='Planner and controller update rate in Hz.',
        ),
        DeclareLaunchArgument(
            'wheel_base',
            default_value='0.255',
        ...
        DeclareLaunchArgument(
            ...
            description='Internal speed command topic between MS5 nodes.',
        ),
        DeclareLaunchArgument(
            'steering_command_topic',
            default_value='/ms3/steering_command',
            description='Internal steering-angle command topic.',
        ),
        DeclareLaunchArgument(
            'command_topic',
        ...
        DeclareLaunchArgument(
            'lateral_kd',
            default_value='0.10',
            description='Low-speed softening term for the lateral controller.',
        ),
        DeclareLaunchArgument(
        ...
        DeclareLaunchArgument(
            'measurement_x_std',
            default_value='0.03',
            description='White Gaussian measurement noise standard deviation for x in meters.',
        ),
        DeclareLaunchArgument(
            'measurement_y_std',
            default_value='0.03',
            description='White Gaussian measurement noise standard deviation for y in meters.',
        ),
        DeclareLaunchArgument(
            'measurement_heading_std',
            default_value='0.04',
            description='White Gaussian measurement noise standard deviation for heading in radians.',
        ),
        DeclareLaunchArgument(
            'measurement_speed_std',
            default_value='0.05',
            description='White Gaussian measurement noise standard deviation for speed in m/s.',
        ),
        DeclareLaunchArgument(
            'measurement_yaw_rate_std',
            default_value='0.08',
            description='White Gaussian measurement noise standard deviation for yaw rate in rad/s.',
        ),
        DeclareLaunchArgument(
            'process_speed_std',
            default_value='0.025',
            description='Process-noise standard deviation for speed in the Kalman filter.',
        ),
        DeclareLaunchArgument(
            'process_yaw_rate_std',
            default_value='0.05',
            description='Process-noise standard deviation for yaw rate in the Kalman filter.',
        ),
        DeclareLaunchArgument(
            'publish_noisy_state',
            default_value='true',
            description='Publish the noisy intermediate odometry for debugging and plotting.',
        ),
        DeclareLaunchArgument(
            'save_artifacts',
            default_value='true',
            description='Write CSV and PNG graphs when the node shuts down.',
        ),
        DeclareLaunchArgument(
            'artifact_output_dir',
            default_value=os.path.join(os.path.expanduser('~'), '.ros', 'team23_ms5'),
            description='Directory used to save the MS5 graphs and CSV history.',
        ),
        DeclareLaunchArgument(
            'artifact_stem',
            default_value='team23_ms5',
            description='Filename stem for MS5 artifacts.',
        ),
        gazebo_gui,
        gazebo_headless,
        delayed_start,
