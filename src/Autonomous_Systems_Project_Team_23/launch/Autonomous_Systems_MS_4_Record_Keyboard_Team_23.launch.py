"""MS4 simulation record+keyboard teleop launch file for Team 23."""
...
def generate_launch_description():
    ...
    record_path = os.path.expanduser('~/ms4_cmd_record.csv')
    ...
    recorder_node = Node(
        package=package_name,
        executable='ms4_cmd_record_team_23',
        name='ms4_cmd_record_team_23',
        output='screen',
        parameters=[{
            'input_topic': '/model/vehicle/cmd_vel',
